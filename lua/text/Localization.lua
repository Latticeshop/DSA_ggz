...
Localization._text_sources = {
    ...
    ["hextech.rune.cloudbreaker.desc"] = { zh = "在你的基地生成 1 个摇光，并由系统回收进单位池。", en = "Spawn 1 Yaoguang at your base to be collected into your unit pool." },
    ["hextech.rune.oil_king.name"] = { zh = "石油王", en = "Oil King" },
    ["hextech.rune.oil_king.desc"] = { zh = "在你的基地获得两个油井。", en = "Gain two Oil Derricks at your base." },
    ...
    ["hextech.rune.fortified.desc"] = { zh = "己方当前仍存活的最前端防御塔最大生命提高 1500。", en = "Your frontmost surviving allied defense tower gains 1,500 maximum health." },
    ["hextech.rune.recycler.name"] = { zh = "破烂王", en = "Recycler" },
    ["hextech.rune.recycler.desc"] = { zh = "你的单位回收收益提高 20%%。", en = "Your unit recycling income is increased by 20%%." },
