...
Localization._text_sources = {
    ...
    ["hextech.test.dialog.title"] = { zh = "【测试】选择你的海克斯符文", en = "[Test] Choose your Hextech rune" },
    ...
    ["hextech.rune.strength.desc"] = { zh = "%s单位造成的伤害提高 25%%。", en = "%s units deal 25%% increased damage." },
    ["hextech.rune.swiftness.name"] = { zh = "迅捷", en = "Swiftness" },
    ["hextech.rune.swiftness.desc"] = { zh = "%s单位攻击速度提高 25%%。", en = "%s units gain 25%% attack speed." },
    ["hextech.rune.hunt.name"] = { zh = "巡猎", en = "The Hunt" },
    ["hextech.rune.hunt.desc"] = { zh = "%s单位移动速度提高 25%%。", en = "%s units gain 25%% movement speed." },
    ...
    ["hextech.rune.astral_body.desc"] = { zh = "%s单位生命提高 50%%，但造成的伤害降低 10%%。", en = "%s units gain 50%% health but deal 10%% less damage." },
    ...
    ["hextech.rune.sea_overlord.desc"] = { zh = "获得 1 个奥林匹斯级航空母舰。", en = "Gain 1 Olympus-class Aircraft Carrier." },
    ["hextech.rune.transcendent_evil.name"] = { zh = "超凡邪恶", en = "Transcendent Evil" },
    ["hextech.rune.transcendent_evil.desc"] = { zh = "%s单位的生命和造成的伤害每回合提高2%%。", en = "%s units gain 2%% health and damage per current round." },
    ...
    ["hextech.rune.scope.prismatic.desc"] = { zh = "%s单位射程提高 35%%。", en = "%s units gain 35%% range." },
    ...
    ["hextech.rune.oblivion_bomb.desc"] = { zh = "在场地中心生成一个湮灭炸弹。", en = "Spawn an Oblivion Bomb at the center of the battlefield." },
