...
Localization._text_sources = {
    ...
    ["hextech.rune.astral_body.desc"] = { zh = "%s单位生命提高 90%%，但造成的伤害降低 25%%。", en = "%s units gain 90%% health but deal 25%% less damage." },
    ...
    ["hextech.rune.starting_funds.desc"] = { zh = "立即获得 15000 资金。", en = "Immediately gain 15,000 credits." },
    ...
    ["hextech.rune.five_thunder.desc"] = { zh = "每 3 回合获得一次五雷天罚。", en = "Gain one Five-Thunder Judgment every 3 rounds." },
