...
g_HextechFrameGoldId = exPackedTextureImageCreate({
    ...
    CoordsX = 0, CoordsY = 0,
    -- 贴图的尺寸
    DimensionsX = HextechFrameGold.size[1], DimensionsY = HextechFrameGold.size[2],
    -- 源纹理的尺寸
    TextureDimensionsX = HextechFrameGold.size[1], TextureDimensionsY = HextechFrameGold.size[2],
    -- 旋转角度
    Rotated = 0
})
...
g_HextechFrameSilverId = exPackedTextureImageCreate({
    ...
    CoordsX = 0, CoordsY = 0,
    -- 贴图的尺寸
    DimensionsX = HextechFrameSilver.size[1], DimensionsY = HextechFrameSilver.size[2],
    -- 源纹理的尺寸
    TextureDimensionsX = HextechFrameSilver.size[1], TextureDimensionsY = HextechFrameSilver.size[2],
    -- 旋转角度
    Rotated = 0
})
...
g_HextechFramePrismaticId = exPackedTextureImageCreate({
    ...
    CoordsX = 0, CoordsY = 0,
    -- 贴图的尺寸
    DimensionsX = HextechFramePrismatic.size[1], DimensionsY = HextechFramePrismatic.size[2],
    -- 源纹理的尺寸
    TextureDimensionsX = HextechFramePrismatic.size[1], TextureDimensionsY = HextechFramePrismatic.size[2],
    -- 旋转角度
    Rotated = 0
})
