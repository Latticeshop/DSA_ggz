...
g_PureDrawBuildableUnitPool = {
    [1] = {
        ...
        { Type = "SovietAntiVehicleInfantry", CustomDrawCount = 4 },
        ...
        { Type = "JapanArcherInfantry", CustomDrawCount = 4 },
        { Type = "CelestialScoutDrone", CustomDrawCount = 5 },
        { Type = "CelestialAntiInfantryInfantry", CustomDrawCount = 5 },
        { Type = "CelestialAntiVehicleInfantry", CustomDrawCount = 3 },
        { Type = "AlliedAntiInfantryVehicle_Ground", CustomDrawCount = 2 },
        { Type = "AlliedAntiAirVehicleTech1", CustomDrawCount = 2 },
        { Type = "AlliedAntiVehicleVehicleTech1", CustomDrawCount = 2 },
        { Type = "SovietScoutVehicle", CustomDrawCount = 2 },
        { Type = "SovietAntiInfantryVehicle", CustomDrawCount = 2 },
        { Type = "SovietAntiAirShip", CustomDrawCount = 2 }, -- 禁海模式使用的陆地形态仍合法
        { Type = "JapanAntiInfantryVehicle", CustomDrawCount = 2 },
        { Type = "JapanAntiVehicleVehicleTech1" },
        { Type = "JapanAntiAirVehicleTech1" },
        { Type = "CelestialAntiInfantryVehicle_B", CustomDrawCount = 2 },
        { Type = "CelestialAntiAirShip", CustomDrawCount = 2 }, -- 禁海模式使用的陆地形态仍合法
        { Type = "CelestialAntiVehicleVehicleTech1" },
        { Type = "CelestialAntiAirVehicle", CustomDrawCount = 2 },
        ...
        { Type = "AlliedAntiNavalScout", CustomDrawCount = 2, Sea = true },
        { Type = "AlliedAntiInfantryVehicle", CustomDrawCount = 2, Sea = true },
        { Type = "AlliedAntiAirShip", CustomDrawCount = 2, Sea = true },
        -- 禁海规则下以陆地形态保留，但沿用现有第3回合解锁限制。
        { Type = "SovietAntiNavyShipTech1", NoNavyProductionUnlockRound = 3 },
        { Type = "JapanNavyScoutShip", CustomDrawCount = 2, Sea = true },
        { Type = "JapanAntiAirShip", Sea = true },
        { Type = "CelestialAntiNavyShipTech1", CustomDrawCount = 2, Sea = true },
    },
    [2] = {
        { Type = "AlliedCryoLegionnaire" },
        { Type = "SovietMortarCycle", CustomDrawCount = 2, ProductionUnlockRound = 1 },
        { Type = "SovietHeavyAntiVehicleInfantry", CustomDrawCount = 2 },
        { Type = "JapanInfiltrationInfantry", CustomDrawCount = 2 },
        { Type = "CelestialInfiltrationInfantry", CustomDrawCount = 2 },
        ...
        { Type = "JapanInterceptorAircraft", CustomDrawCount = 2 },
